...
const images = {
  ...
  icArrowRight: require('./ic-right.png'),
  icCamera: require('./ic-camera.png'),
  icCake: require('./ic-birthday-cake.png'),

  defaultAvatar: require('./default-avt.png'),
  bike: require('./test-bike.png'),
